...
function connect() {
  ...
  connection.onmessage = function(evt) {
    ...
    switch(msg.type) {
      ...
      case "rejectusername":
        myUsername = msg.name;
        text = "<b>Your username is not correct!<em>";
        
        // text = "<b>Your username has been set to <em>" + myUsername +
        //   "</em> because the name you chose is in use.</b><br>";
        break;
        case "rejectusernamelogged":
          myUsername = msg.name;
          text = "<b>Already logged in!<em>";
...
async function createPeerConnection() {
    ...
    iceServers: [     // Information about ICE servers - Use your own!
      {
        ...
        urls: "turn:turn.jannatenterprise.com:3478",
        username: "guest",
        credential: "pass"
      }
    ],
  ...
  // console.log(myPeerConnection.canTrickleIceCandidates);
